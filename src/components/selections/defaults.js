...
function handleShapeDefaults(selectionIn, selectionOut, fullLayout) {
    ...
    if(selectionOut.type !== 'path') delete selectionOut.path;
    ...
    for(var i = 0; i < 2; i++) {
        ...
        // xref, yref
        var axRef = Axes.coerceRef(selectionIn, selectionOut, gdMock, axLetter, undefined,
            'paper');
